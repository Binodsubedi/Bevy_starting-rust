...
fn setup(mut commands: Commands, asset_server: Res<AssetServer>) {
    let ship_handle = asset_server.load("textures/ship.png");
    let enemy_a_handle = asset_server.load("textures/enemy_1.png");
    let enemy_b_handle = asset_server.load("textures/enemy_2.png");
